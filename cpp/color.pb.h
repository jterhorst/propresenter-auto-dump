...
/* @@protoc_insertion_point(class_definition:rv.data.Color) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "rv.data.Color"; }
...
inline float Color::red() const {
  // @@protoc_insertion_point(field_get:rv.data.Color.red)
  return _internal_red();
}
inline void Color::set_red(float value) {
  _internal_set_red(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_set:rv.data.Color.red)
}
...
inline float Color::green() const {
  // @@protoc_insertion_point(field_get:rv.data.Color.green)
  return _internal_green();
}
inline void Color::set_green(float value) {
  _internal_set_green(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000002U);
  // @@protoc_insertion_point(field_set:rv.data.Color.green)
}
...
inline float Color::blue() const {
  // @@protoc_insertion_point(field_get:rv.data.Color.blue)
  return _internal_blue();
}
inline void Color::set_blue(float value) {
  _internal_set_blue(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000004U);
  // @@protoc_insertion_point(field_set:rv.data.Color.blue)
}
...
inline float Color::alpha() const {
  // @@protoc_insertion_point(field_get:rv.data.Color.alpha)
  return _internal_alpha();
}
inline void Color::set_alpha(float value) {
  _internal_set_alpha(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000008U);
  // @@protoc_insertion_point(field_set:rv.data.Color.alpha)
}
inline float Color::_internal_alpha() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.alpha_;
}
inline void Color::_internal_set_alpha(float value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.alpha_ = value;
}
