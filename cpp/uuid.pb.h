...
#ifndef uuid_2eproto_2epb_2eh
#define uuid_2eproto_2epb_2eh
...
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_uuid_2eproto;
}  // extern "C"
namespace rv {
namespace data {
class UUID;
struct UUIDGlobalsTypeInternal;
#ifndef PROTOBUF_MESSAGE_GLOBALS
extern UUIDGlobalsTypeInternal UUID_globals_;
extern const ::google::protobuf::internal::ClassDataFull UUID_class_data_;
#else
extern const UUIDGlobalsTypeInternal UUID_globals_;
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED UUID final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:rv.data.UUID) */ {
 public:
  ...
  explicit constexpr UUID(::google::protobuf::internal::ConstantInitialized,
                           const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
                               class_data);

  inline UUID(const UUID& from) : UUID(nullptr, from) {}
  inline UUID(UUID&& from) noexcept : UUID(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const UUID& default_instance() {
    return *::google::protobuf::internal::MessageGlobalsBase::ToDefaultInstance<UUID>(&UUID_globals_);
  }
  ...
  [[nodiscard]] UUID* PROTOBUF_NONNULL
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "rv.data.UUID"; }
...
inline const ::std::string& UUID::string() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:rv.data.UUID.string)
  return _internal_string();
}
template <typename Arg_, typename... Args_>
PROTOBUF_ALWAYS_INLINE void UUID::set_string(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  _impl_.string_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:rv.data.UUID.string)
}
inline ::std::string* PROTOBUF_NONNULL UUID::mutable_string()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  ::std::string* _s = _internal_mutable_string();
  // @@protoc_insertion_point(field_mutable:rv.data.UUID.string)
  return _s;
}
...
inline ::std::string* PROTOBUF_NONNULL UUID::_internal_mutable_string() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _impl_.string_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE UUID::release_string() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:rv.data.UUID.string)
...
inline void UUID::set_allocated_string(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  } else {
  ...
  // @@protoc_insertion_point(field_set_allocated:rv.data.UUID.string)
}
