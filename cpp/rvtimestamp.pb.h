...
#ifndef rvtimestamp_2eproto_2epb_2eh
#define rvtimestamp_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_rvtimestamp_2eproto
...
struct TableStruct_rvtimestamp_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_rvtimestamp_2eproto;
}  // extern "C"
namespace rv {
namespace data {
class Timestamp;
...
class  PROTOBUF_FUTURE_ADD_EARLY_WARN_UNUSED Timestamp final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:rv.data.Timestamp) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "rv.data.Timestamp"; }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_rvtimestamp_2eproto;
};
...
inline ::int64_t Timestamp::seconds() const {
  // @@protoc_insertion_point(field_get:rv.data.Timestamp.seconds)
  return _internal_seconds();
}
inline void Timestamp::set_seconds(::int64_t value) {
  _internal_set_seconds(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000001U);
  // @@protoc_insertion_point(field_set:rv.data.Timestamp.seconds)
}
...
inline ::int32_t Timestamp::nanos() const {
  // @@protoc_insertion_point(field_get:rv.data.Timestamp.nanos)
  return _internal_nanos();
}
inline void Timestamp::set_nanos(::int32_t value) {
  _internal_set_nanos(value);
  SetHasBit(_impl_._has_bits_[0], 0x00000002U);
  // @@protoc_insertion_point(field_set:rv.data.Timestamp.nanos)
}
...
#endif  // rvtimestamp_2eproto_2epb_2eh
