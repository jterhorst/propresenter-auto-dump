...
module Rv
  module Data
    MacrosDocument = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.MacrosDocument").msgclass
    MacrosDocument::Macro = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.MacrosDocument.Macro").msgclass
    MacrosDocument::Macro::ImageType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.MacrosDocument.Macro.ImageType").enummodule
    MacrosDocument::MacroCollection = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.MacrosDocument.MacroCollection").msgclass
    MacrosDocument::MacroCollection::Item = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.MacrosDocument.MacroCollection.Item").msgclass
  end
end
