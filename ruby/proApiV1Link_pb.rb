...
module Rv
  module Data
    API_v1_GroupMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_GroupMember").msgclass
    API_v1_GroupMemberStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_GroupMemberStatus").msgclass
    API_v1_GroupMemberStatus::API_v1_GroupMemberStatus_ConnectionStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_GroupMemberStatus.API_v1_GroupMemberStatus_ConnectionStatus").enummodule
    API_v1_GroupMemberStatus::API_v1_GroupMemberStatus_Platform = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_GroupMemberStatus.API_v1_GroupMemberStatus_Platform").enummodule
    API_v1_GroupDefinition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_GroupDefinition").msgclass
    API_v1_Link_Request = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Request").msgclass
    API_v1_Link_Request::Heartbeat = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Request.Heartbeat").msgclass
    API_v1_Link_Request::Status = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Request.Status").msgclass
    API_v1_Link_Request::AddMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Request.AddMember").msgclass
    API_v1_Link_Request::RemoveMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Request.RemoveMember").msgclass
    API_v1_Link_Response = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response").msgclass
    API_v1_Link_Response::Heartbeat = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.Heartbeat").msgclass
    API_v1_Link_Response::Status = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.Status").msgclass
    API_v1_Link_Response::AddMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.AddMember").msgclass
    API_v1_Link_Response::AddMember::RemoteMachineAccepts = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.AddMember.RemoteMachineAccepts").msgclass
    API_v1_Link_Response::AddMember::RemoteMachineDecline = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.AddMember.RemoteMachineDecline").msgclass
    API_v1_Link_Response::AddMember::RemoteMachineDecline::DeclineReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.AddMember.RemoteMachineDecline.DeclineReason").enummodule
    API_v1_Link_Response::RemoveMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.API_v1_Link_Response.RemoveMember").msgclass
  end
end
