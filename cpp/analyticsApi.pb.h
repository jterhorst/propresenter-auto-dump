...
/* @@protoc_insertion_point(class_definition:rv.analytics.api.MessageReceived) */ {
 public:
  ...
  inline void CopyFrom(const MessageReceived& from) { ::google::protobuf::internal::ZeroFieldsBase::CopyImpl(*this, from); }
  using ::google::protobuf::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(const MessageReceived& from) { ::google::protobuf::internal::ZeroFieldsBase::MergeImpl(*this, from); }
