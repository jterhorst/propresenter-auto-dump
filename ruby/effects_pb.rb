...
module Rv
  module Data
    Effect = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect").msgclass
    Effect::EffectVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable").msgclass
    Effect::EffectVariable::EffectInt = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable.EffectInt").msgclass
    Effect::EffectVariable::EffectFloat = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable.EffectFloat").msgclass
    Effect::EffectVariable::EffectDouble = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable.EffectDouble").msgclass
    Effect::EffectVariable::EffectColor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable.EffectColor").msgclass
    Effect::EffectVariable::EffectDirection = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable.EffectDirection").msgclass
    Effect::EffectVariable::EffectDirection::EffectDirection = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.EffectVariable.EffectDirection.EffectDirection").enummodule
    Effect::Preset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Effect.Preset").msgclass
    Transition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Transition").msgclass
    Transition::Preset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.Transition.Preset").msgclass
  end
end
