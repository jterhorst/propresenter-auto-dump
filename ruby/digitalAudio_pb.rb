...
module Rv
  module Data
    DigitalAudio = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio").msgclass
    DigitalAudio::Setup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Setup").msgclass
    DigitalAudio::Bus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Bus").msgclass
    DigitalAudio::Device = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Device").msgclass
    DigitalAudio::Device::Format = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Device.Format").msgclass
    DigitalAudio::Device::Format::Type = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Device.Format.Type").enummodule
    DigitalAudio::Device::Map = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Device.Map").msgclass
    DigitalAudio::Device::Channel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Device.Channel").msgclass
    DigitalAudio::Device::Routing = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("rv.data.DigitalAudio.Device.Routing").msgclass
  end
end
